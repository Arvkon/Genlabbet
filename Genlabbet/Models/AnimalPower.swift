...
enum AnimalPower {
    case amphibian
    //case antlers (Not in Swedish version of the game)
    case burrower
    case climber
    case fastReflexes
    case fleetFooted
    ...
    var string: String {
        switch self {
        case .amphibian:        return "Amfibisk"
        case .burrower:         return "Grävare"
        case .climber:          return "Klättrare"
        case .fastReflexes:     return "Blixtsnabb"
        case .fleetFooted:      return "Löpsnabb"
        case .flightResponse:   return "Flyktsinne"
        case .furry:            return "Lurvig"
        case .herbivore:        return "Växtätare"
        case .huge:             return "Stor"
        case .huntingInstincts: return "Jaktsinne"
        case .jumper:           return "Hoppförmåga"
        case .naturalArmor:     return "Pansar"
        case .nocturnal:        return "Nattsyn"
        case .poisonousBite:    return "Giftbett"
        case .predator:         return "Rovattack"
        case .silent:           return "Ljudlös"
        case .sixthSense:       return "Sjätte sinne"
        case .small:            return "Liten"
        case .tail:             return "Svans"
        case .warningCall:      return "Varningsrop"
        }
    }
